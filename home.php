...
<main class="wrapper main-home">
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="images/home1.jpg" class="d-block w-100" alt="phone repair">
            </div>
            <div class="carousel-item">
                <img src="images/home2.jpg" class="d-block w-100" alt="phone repair">
            </div>
            <div class="carousel-item">
                <img src="images/home3.jpg" class="d-block w-100" alt="phone repair">
            </div>
        </div>
    </div>
    <div class="container"> 
        <div class="jumbotron">
            <h1 class="display-4">Welcome to iREPAIR</h1>
            <p class="lead">We are a phone repair service located in NYC. We offer complete repairs on phones ranging from cracked screens to water damaged devices.</p>
            <hr class="my-4">
            <p>All inquiries and transactions will take place through this site. Simply, make a profile and send us your inquiry with a picture of your device and a short description. Then, send us the phone, and we will send you an estimate for the repair. Once, the status shows that your repair is complete, you can pay for the repair throught this site and we will send your repaired device right away.</p>
            <?php 
                if(!isset($_COOKIE['username'])){
                    echo "<a class='btn btn-primary btn-lg' href='login.php' role='button'>Login Or Sign Up</a>";
                }
                else{
                    echo "<a class='btn btn-primary btn-lg' href='profile.php' role='button'>Take Me To My Profile</a>";
                }
            ?>
        </div>
    </div>
