    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col d-flex justify-content-center">
                <?php 
                    include"includes/custInfoForm.inc.php";
                ?>
                <form action="custInfoForm.php" method="POST">
                    <label for="firstNameInput">First Name: </label>
                    <input type="text" class="form-control" id="firstNameInput" name="firstName" maxlength="40">
                    <label for="lastNameInput">Last Name: </label>
                    <input type="text" class="form-control" id="lastNameInput" name="lastName" maxlength="40">  
                    <label for="emailInput">Email: </label>
                    <input type="email" class="form-control" id="emailInput" name="email" maxlength="100">
                    <label for="phoneNumInput">Phone Number:  </label>
                    <input type="text" class="form-control" id="phoneNumInput" name="phoneNum"></input>   
                    <label for="addressInput">Address:  </label>
                    <input type="text" class="form-control" id="addressInput" name="address"></input>  
                    <label for="cityInput">City:  </label>
                    <input type="text" class="form-control" id="cityInput" name="city"></input>  
                    <label for="stateInput">State:  </label>
                    <input type="text" class="form-control" id="stateInput" name="state"></input>
                    <label for="zipInput">Zipcode:  </label>
                    <input type="text" class="form-control" id="zipInput" name="zip"></input><br>   
