        ...
        <div class="row">
            <div class="col-2 profile-list">
                <?php 
                    ...
                    else{   //prompt log in if we do not have their cookie
            ...
            <div class="col d-flex justify-content-center">
                <ul>
                <?php
                    include"includes/custInfo.inc.php";
                    if(array_key_exists("editCusInfo", $_POST)){
                        header("location: custInfoForm.php");
                    }
                ?>
                <form action="custInfo.php" method="POST">
                    <button type="submit" class="btn btn-primary" name="editCusInfo">Edit Info</button>
                </ul>
            </div>
        </div>
    </div>
