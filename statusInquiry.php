    ...
    <div class="container">
        <div class="row">
            <div class="col-2 profile-list">
                <?php 
                    ...
                    if(isset($_COOKIE['username'])){
                        ...
                        if($numOfRows == 0){    //if there are no records then we get their information
                            header("location: custInfoForm.php");
                        }
                    }
                    else{   //go to login if we dont have their cookie
            ...
            <div class="col d-flex justify-content-center">
                <ul>
                <?php 
                    include"includes/statusInquiry.inc.php";
                ?>
                </ul>
                </table>
            </div>
