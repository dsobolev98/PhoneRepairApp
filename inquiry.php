        ...
        <div class="row">
            <div class="col-2 profile-list">
                <?php 
                    ...
                    else{   //we need their cookie to log in
            ...
            <div class="col d-flex justify-content-center inquiry-control">
                <form action="images/inquiry.inc.php" method="POST" enctype="multipart/form-data">
                    <label for="makeInput">Make: </label>
                    <input type="text" class="form-control" id="makeInput" name="make" maxlength="45">
                    <label for="modelInput">Model: </label>
                    <input type="text" class="form-control" id="modelInput" name="model" maxlength="45">  
                    <label for="serialNumInput">Serial Number: </label>
                    <input type="text" class="form-control" id="serialNumInput" name="serialNum" maxlength="100">
                    <label for="issueInput">Issue: </label>
                    <textarea class="form-control" id="issueInput" name="issue"></textarea><br>   
                    <label for="fileUpload">Please select an image of the device you would like to upload:</label>
                    <input type="file" class="form-control-file" name="photo" id="fileUpload"><br>
                    <button type="submit" class="btn btn-primary" name="submit">Submit Info</button>
                </form>
            </div>
        </div>
    </div>
