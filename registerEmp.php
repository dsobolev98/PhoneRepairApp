    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col d-flex justify-content-center">
                <form action="includesEmp/registerEmp.inc.php" method="POST">
                    <label for="userNameInput">Username: </label>
                    <input type="text" class="form-control" id="userNameInput" name="username" maxlength="20" required> 
                    <label for="passwordInput">Password: </label>
                    <input type="password" class="form-control" id="passwordInput" name="password" minlength="6" maxlength="20" required>
                    <label for="firstNameInput">First Name: </label>
                    <input type="text" class="form-control" id="firstInput" name="firstname" maxlength="40" required>
                    <label for="lastNameInput">Last Name: </label>
                    <input type="text" class="form-control" id="lastInput" name="lastname" maxlength="40" required>
                    <label for="emailInput">Email: </label>
                    <input type="email" class="form-control" id="emailInput" name="email" maxlength="100" required>
                    <label for="phoneInput">Phone Number: </label>
                    <input type="text" class="form-control" id="phoneInput" name="phoneNum" maxlength="10" required>
                    <button type="submit" class="btn btn-primary" name="submit">Create Worker</button>
                </form>
            </div>
        </div>
    </div>
